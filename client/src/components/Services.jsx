		...
		<div className="container">
			...
			<div className="services-container">
				<article className="services-article-container">
					...
					<button className="open-modal-button" onClick={() => openModal("Пакет базовый «Light»")}>
						Оставить заявку
					</button>
				</article>
				<article className="services-article-container">
					...
					<button className="open-modal-button" onClick={() => openModal("Пакет полный «PRO»")}>
						Оставить заявку
					</button>
				</article>
				<article className="services-article-container">
					...
					<div className="services-article-content">
						<p>
							...
							будущий интерьер, или хотите оптимизировать затраты на ремонт, этот пакет станет для вас идеальным
							выбором. Я помогу грамотно спланировать размещение мебели, освещения и необходимых электровыводов, чтобы
							ваше пространство стало максимально удобным, функциональным и радовало вас долгие годы.
						</p>
					</div>
					<button className="open-modal-button" onClick={() => openModal("Разработка планировочного решения")}>
						Оставить заявку
					</button>
				</article>
				<article className="services-article-container">
					...
					<button className="open-modal-button" onClick={() => openModal("Авторский надзор")}>
						Оставить заявку
					</button>
				</article>
			</div>
			...
			<ContactForm />
			{/* <ModalServices isOpen={isModalOpen} onClose={closeModal} packageName={selectedPackage} /> */}
		</div>
	);
};
